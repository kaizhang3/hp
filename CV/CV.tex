...
\begin{etaremune}
 ...
 \item Tu, Y., \textbf{Zhang, K.}*, Han, Z., Zhou, D. \& Bilgen, O. (2022) Aerodynamic characterization of two tandem wind turbines under yaw misalignment control using actuator line model. \textit{\textbf{Ocean Engineering}}, 281, 114992.
...
\item LIU, Yang-Ming 【刘扬明】，2023 -- present
\item SHAO, Yi-Xiao 【邵逸骁】(with Prof. D. Zhou),   2023 -- present
\end{myitemize}

\noindent {\bf \color{Blue}Previous Master students}
\begin{myitemize}
\itemsep 0.5em 
\item WANG, Zhen-Fan 【王振凡】 (with Prof. D. Zhou), 2022 -- 2023 
\end{myitemize}

\noindent {\bf \color{Blue}Previous Undergraduate students}
\begin{myitemize}
\itemsep 0.5em 
